        ...
        $rootNode
            ->children()
                    ...
                    ->children()
                        ->arrayNode('pagination')
                            ...
                            ->children()
                                ...
                                ->scalarNode('consumer_payments')->defaultValue(20)->end()
                                ->scalarNode('sales_orders')->defaultValue(20)->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('producer')
                    ...
                    ->end()
                ->end()
                ->arrayNode('producer_sales_orders')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('pagination')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('branch_occurrences')->defaultValue(4)->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
